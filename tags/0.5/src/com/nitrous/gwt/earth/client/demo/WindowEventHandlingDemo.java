...
/**
 * A GWT implementation of the demo found <a href="http://code.google.com/apis/ajax/playground/#globe/window_event_handling">here</a>.
 * 
 * @author nick
 * 
 */
public class WindowEventHandlingDemo implements EntryPoint {
	...
	private void loadMapContent() {
		...
		GoogleEarth.addEventListener(ge.getGlobe(), "click", new KmlEventListener() {
		...
		GoogleEarth.addEventListener(ge.getWindow(), "click", new KmlEventListener() {
