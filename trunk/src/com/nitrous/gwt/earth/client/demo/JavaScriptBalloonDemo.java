...
/**
 * A GWT implementation of the demo found <a href="http://code.google.com/apis/ajax/playground/#javascript_in_balloons">here</a>.
 * 
 * @author nick
 * 
 */
public class JavaScriptBalloonDemo implements EntryPoint {
	/** 
	...
	private void loadMapContent() {
		...
		ge.getWindow().addMouseClickListener(new MouseClickListener() {
            ...
            public void onClick(KmlMouseEvent event) {
                ...
                balloon.setFeature((KmlFeature)event.getTarget());
