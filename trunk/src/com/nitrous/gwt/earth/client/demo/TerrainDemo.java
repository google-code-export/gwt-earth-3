...
/**
 * A GWT implementation of the demo found <a href="http://code.google.com/apis/ajax/playground/#show/hide_terrain">here</a>.
 * 
 * @author nick
 * 
 */
public class TerrainDemo implements EntryPoint {
    ...
    private void onApiLoaded() {
		...
		Button showButton = new Button("Show Terrain");
		...
		Button hideButton = new Button("Hide Terrain");
	...
	private void loadMapContent() {
		...
		la.set(36.291068, -112.4981896, 0, KmlAltitudeMode.ALTITUDE_RELATIVE_TO_GROUND, 0, 80, 20000);
	...
	private void hideTerrain() {
		GEPlugin ge = earth.getGEPlugin();
		ge.enableLayer(GELayerId.LAYER_TERRAIN, false);
	}
