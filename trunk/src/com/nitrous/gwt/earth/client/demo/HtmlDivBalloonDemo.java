...
/**
 * A GWT implementation of the demo found <a href="http://code.google.com/apis/ajax/playground/#html_div_balloons">here</a>.
 * 
 * @author nick
 * 
 */
public class HtmlDivBalloonDemo implements EntryPoint {
    ...
    private void onApiLoaded() {
		...
		Button showButton = new Button("Show an HTML Div Balloon!");
		showButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				String html = "<img src=\"http://www.google.com/googlegulp/images/logo.gif\"><br>"
				          + "<a href=\"http://www.google.com/googlegulp/\">Google Gulp</a>";
				balloon.setContentDiv(html);
