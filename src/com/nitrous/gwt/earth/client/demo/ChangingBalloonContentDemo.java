...
import com.nitrous.gwt.earth.client.api.GEAbstractBalloon;
...
/**
 * A GWT implementation of the demo found <a href="http://code.google.com/apis/ajax/playground/#changing_balloon_content">here</a>
 * 
 * @author nick
 * 
 */
public class ChangingBalloonContentDemo implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		Button changeButton = new Button("Change its content!");
		changeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				GEAbstractBalloon balloon = ge.getBalloon();
				if (balloon != null) {
				    // Pigeon Rank
				    String content =
				    ...
				    if ("GEHtmlStringBalloon".equals(balloon.getType())) {
				    	((GEHtmlStringBalloon)balloon).setContentString(content);
				    } else if ("GEHtmlDivBalloon".equals(balloon.getType())) {
				    	((GEHtmlDivBalloon)balloon).setContentDiv(content);
				    } else if ("GEFeatureBalloon".equals(balloon.getType())) {
