...
/**
 * This demo illustrates how to load the Google Earth API using Java code instead of having to insert a script tag in the application host page.
 * 
 * @author Nick
 *
 */
public class ApiLoadingDemo implements EntryPoint {
	/** 
